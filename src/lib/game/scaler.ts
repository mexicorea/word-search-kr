...
export const GRID_CONFIGS: Record<GridSize, GridConfig> = {
  ...
  '7x5': { cols: 7, rows: 5, wordCount: 4, timeSeconds: 70 },
  '8x6': { cols: 8, rows: 6, wordCount: 5, timeSeconds: 80 },
  '8x7': { cols: 8, rows: 7, wordCount: 6, timeSeconds: 90 },
  '8x8': { cols: 8, rows: 8, wordCount: 7, timeSeconds: 100 },
}
